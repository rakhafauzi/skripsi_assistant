...
<div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-3">
  <div>
    ...
    <div class="small text-secondary">
      Mahasiswa: <?= e((string)($item['user_name'] ?? '')) ?> (<?= e((string)($item['user_email'] ?? '')) ?>) •
      Feature: <?= e(strtoupper((string)($item['feature'] ?? ''))) ?> •
      Model: <?= e((string)($item['model'] ?? '')) ?> •
      Token: <?= e((string)($item['total_tokens'] ?? 0)) ?>
    </div>
  </div>
  <div class="d-flex gap-2">
    <a class="btn btn-outline-secondary" href="<?= e(url('admin/ai-history')) ?>"><i class="bi bi-arrow-left me-1"></i>Kembali</a>
